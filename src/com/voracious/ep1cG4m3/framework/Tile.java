...
public class Tile extends Drawable {
	...
	tileIds.put(Brick.id, Brick.getName());
    }
     ...
     * 
     * @param entity
     *            the entity that came in contact with this tile
     */
     ...
     * 
     * @param entity
     *            the entity that broke contact with this tile
     */
     ...
     * 
     * @param isAir
     *            Set the block to be air or not
     */
     ...
     * 
     * @param name
     *            the name of the tile to return
