...
/**
 * Represents the player. A user should be able to control the actions of this
 * object.
 * 
...
public class Player extends Entity {
     ...
     * 
     * @param location
     *            point the rotate to face. (Usually the mouse pointer location)
     */
