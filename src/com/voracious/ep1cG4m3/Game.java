...
public class Game extends JFrame implements ScreenResultEvent {
	...
	private String filePaths[] = {"/font.png", "/entities/player.png"};
	...
	public void sendImages(){
		Text.setFont(images[0]); //TODO: Write a method to get an image from it's path in "filePaths"
		//getScreenFromId(PLAY_ID).getCharacter().setCharacterImage(images[1]);
	}
